...
/**
 Base class for all Souza_Denise_WK4Project_App views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Souza_Denise_WK4Project_App view hierarchy (such as wrapped iOS UIViews) was touched.
