...
@interface Souza_Denise_WK4Project_AppObject : KrollCoverageObject {
#else
@interface Souza_Denise_WK4Project_AppObject : KrollObject {
#endif
@private
...
extern NSString * Souza_Denise_WK4Project_App$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Souza_Denise_WK4Project_AppObject *_souza_denise_wk4project_app;
    KrollObject* console;
	BOOL shutdown;
