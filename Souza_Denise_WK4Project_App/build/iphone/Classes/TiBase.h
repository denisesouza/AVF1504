...
// in simulator we redefine to format for Souza_Denise_WK4Project_App Developer console
...
{\
	NSString * exceptionName = [@"org.souza_denise_wk4project_app." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.souza_denise_wk4project_app";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISouza_Denise_WK4Project_AppNativeItemNone = -1, 
	UISouza_Denise_WK4Project_AppNativeItemSpinner = -2,
	UISouza_Denise_WK4Project_AppNativeItemProgressBar = -3,
	
	UISouza_Denise_WK4Project_AppNativeItemSlider = -4,
	UISouza_Denise_WK4Project_AppNativeItemSwitch = -5,
	UISouza_Denise_WK4Project_AppNativeItemMultiButton = -6,
	UISouza_Denise_WK4Project_AppNativeItemSegmented = -7,
	
	UISouza_Denise_WK4Project_AppNativeItemTextView = -8,
	UISouza_Denise_WK4Project_AppNativeItemTextField = -9,
	UISouza_Denise_WK4Project_AppNativeItemSearchBar = -10,
	
	UISouza_Denise_WK4Project_AppNativeItemPicker = -11,
	UISouza_Denise_WK4Project_AppNativeItemDatePicker = -12,
	
	UISouza_Denise_WK4Project_AppNativeItemInfoLight = -13,
	UISouza_Denise_WK4Project_AppNativeItemInfoDark = -14,
	
	UISouza_Denise_WK4Project_AppNativeItemDisclosure = -15,
	
	UISouza_Denise_WK4Project_AppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Souza_Denise_WK4Project_App instances of
