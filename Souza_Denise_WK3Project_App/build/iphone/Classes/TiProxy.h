...
//Rare exceptions to indicate a bug in the _souza_denise_wk3project_app code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Souza_Denise_WK3Project_App proxies.
 */
