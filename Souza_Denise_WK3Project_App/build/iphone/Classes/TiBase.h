...
// in simulator we redefine to format for Souza_Denise_WK3Project_App Developer console
...
{\
	NSString * exceptionName = [@"org.souza_denise_wk3project_app." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.souza_denise_wk3project_app";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISouza_Denise_WK3Project_AppNativeItemNone = -1, 
	UISouza_Denise_WK3Project_AppNativeItemSpinner = -2,
	UISouza_Denise_WK3Project_AppNativeItemProgressBar = -3,
	
	UISouza_Denise_WK3Project_AppNativeItemSlider = -4,
	UISouza_Denise_WK3Project_AppNativeItemSwitch = -5,
	UISouza_Denise_WK3Project_AppNativeItemMultiButton = -6,
	UISouza_Denise_WK3Project_AppNativeItemSegmented = -7,
	
	UISouza_Denise_WK3Project_AppNativeItemTextView = -8,
	UISouza_Denise_WK3Project_AppNativeItemTextField = -9,
	UISouza_Denise_WK3Project_AppNativeItemSearchBar = -10,
	
	UISouza_Denise_WK3Project_AppNativeItemPicker = -11,
	UISouza_Denise_WK3Project_AppNativeItemDatePicker = -12,
	
	UISouza_Denise_WK3Project_AppNativeItemInfoLight = -13,
	UISouza_Denise_WK3Project_AppNativeItemInfoDark = -14,
	
	UISouza_Denise_WK3Project_AppNativeItemDisclosure = -15,
	
	UISouza_Denise_WK3Project_AppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Souza_Denise_WK3Project_App instances of
