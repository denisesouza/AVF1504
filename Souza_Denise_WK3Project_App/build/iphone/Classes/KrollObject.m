...
//@interface Souza_Denise_WK3Project_AppObject : NSObject
//@end

@interface Souza_Denise_WK3Project_AppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Souza_Denise_WK3Project_AppObject class]])
		{
			for (NSString *key in [[(Souza_Denise_WK3Project_AppObject*)o modules] allKeys])
			{
