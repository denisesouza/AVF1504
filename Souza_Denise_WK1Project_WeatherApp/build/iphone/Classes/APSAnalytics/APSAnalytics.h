 ...
 * to send analytic data that can be viewed on the Souza_Denise_WK1Project_WeatherApp Dashboard.
 *
 * For information on getting started with Souza_Denise_WK1Project_WeatherApp Platform Services,
