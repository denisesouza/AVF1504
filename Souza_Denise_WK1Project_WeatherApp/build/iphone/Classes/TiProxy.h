...
//Rare exceptions to indicate a bug in the _souza_denise_wk1project_weatherapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Souza_Denise_WK1Project_WeatherApp proxies.
 */
