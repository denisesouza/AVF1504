...
@interface Souza_Denise_WK1Project_WeatherAppObject : KrollCoverageObject {
#else
@interface Souza_Denise_WK1Project_WeatherAppObject : KrollObject {
#endif
@private
...
extern NSString * Souza_Denise_WK1Project_WeatherApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Souza_Denise_WK1Project_WeatherAppObject *_souza_denise_wk1project_weatherapp;
    KrollObject* console;
	BOOL shutdown;
