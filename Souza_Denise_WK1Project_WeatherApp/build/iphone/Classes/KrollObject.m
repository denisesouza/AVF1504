...
//@interface Souza_Denise_WK1Project_WeatherAppObject : NSObject
//@end

@interface Souza_Denise_WK1Project_WeatherAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Souza_Denise_WK1Project_WeatherAppObject class]])
		{
			for (NSString *key in [[(Souza_Denise_WK1Project_WeatherAppObject*)o modules] allKeys])
			{
