...
/**
 Base class for all Souza_Denise_WK1Project_WeatherApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Souza_Denise_WK1Project_WeatherApp view hierarchy (such as wrapped iOS UIViews) was touched.
