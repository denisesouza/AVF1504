...
//Rare exceptions to indicate a bug in the _souza_denise_wk2project_weatherapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Souza_Denise_WK2Project_WeatherApp proxies.
 */
