...
@interface Souza_Denise_WK2Project_WeatherAppObject : KrollCoverageObject {
#else
@interface Souza_Denise_WK2Project_WeatherAppObject : KrollObject {
#endif
@private
...
extern NSString * Souza_Denise_WK2Project_WeatherApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Souza_Denise_WK2Project_WeatherAppObject *_souza_denise_wk2project_weatherapp;
    KrollObject* console;
	BOOL shutdown;
