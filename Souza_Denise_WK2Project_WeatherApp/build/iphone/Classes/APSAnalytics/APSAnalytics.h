 ...
 * to send analytic data that can be viewed on the Souza_Denise_WK2Project_WeatherApp Dashboard.
 *
 * For information on getting started with Souza_Denise_WK2Project_WeatherApp Platform Services,
