...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.souza_denise_wk2project_weatherapp._souza_denise_wk2project_weatherapp.imageloader" code:1 userInfo:errorDetail];
