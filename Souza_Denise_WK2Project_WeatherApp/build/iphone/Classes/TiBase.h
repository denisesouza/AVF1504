...
// in simulator we redefine to format for Souza_Denise_WK2Project_WeatherApp Developer console
...
{\
	NSString * exceptionName = [@"org.souza_denise_wk2project_weatherapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.souza_denise_wk2project_weatherapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISouza_Denise_WK2Project_WeatherAppNativeItemNone = -1, 
	UISouza_Denise_WK2Project_WeatherAppNativeItemSpinner = -2,
	UISouza_Denise_WK2Project_WeatherAppNativeItemProgressBar = -3,
	
	UISouza_Denise_WK2Project_WeatherAppNativeItemSlider = -4,
	UISouza_Denise_WK2Project_WeatherAppNativeItemSwitch = -5,
	UISouza_Denise_WK2Project_WeatherAppNativeItemMultiButton = -6,
	UISouza_Denise_WK2Project_WeatherAppNativeItemSegmented = -7,
	
	UISouza_Denise_WK2Project_WeatherAppNativeItemTextView = -8,
	UISouza_Denise_WK2Project_WeatherAppNativeItemTextField = -9,
	UISouza_Denise_WK2Project_WeatherAppNativeItemSearchBar = -10,
	
	UISouza_Denise_WK2Project_WeatherAppNativeItemPicker = -11,
	UISouza_Denise_WK2Project_WeatherAppNativeItemDatePicker = -12,
	
	UISouza_Denise_WK2Project_WeatherAppNativeItemInfoLight = -13,
	UISouza_Denise_WK2Project_WeatherAppNativeItemInfoDark = -14,
	
	UISouza_Denise_WK2Project_WeatherAppNativeItemDisclosure = -15,
	
	UISouza_Denise_WK2Project_WeatherAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Souza_Denise_WK2Project_WeatherApp instances of
